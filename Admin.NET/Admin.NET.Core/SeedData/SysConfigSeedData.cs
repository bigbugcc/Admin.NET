...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=1300000000121, Name="密码最大错误次数", Code="sys_max_passwd_err_times", Value="5", SysFlag=YesNoEnum.Y, Remark="允许的密码最大输入错误次数", OrderNo=30, GroupCode="Default", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
