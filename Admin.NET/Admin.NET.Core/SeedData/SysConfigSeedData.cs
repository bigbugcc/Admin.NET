...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=1300000000192, Name="开启记录数据校验日志", Code="sys_validation_log", Value="True", SysFlag=YesNoEnum.Y, Remark="是否记录数据校验日志", OrderNo=110, GroupCode="Default", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
