...
public class SysConfigSeedData : ISqlSugarEntitySeedData<SysConfig>
{
    ...
    public IEnumerable<SysConfig> HasData()
    {
        return new[]
        {
            ...
            new SysConfig{ Id=1300000000101, Name="发送异常日志邮件", Code="sys_error_mail", Value="True", SysFlag=YesNoEnum.Y, Remark="是否发送异常日志邮件", OrderNo=110, GroupCode="Default", CreateTime=DateTime.Parse("2022-02-10 00:00:00") },
